...
public class MediaDAO extends database_connection{
    ...
    public void insertMedia(String nameMedia, String nameCountry) throws Exception{
        sql = "INSERT INTO `media`(ID_MEDIA, NAME_MEDIA, ID_SPEC) VALUES(?,?,(SELECT `specific_theme`.`ID_THEME` FROM `specific_theme` WHERE UPPER(`specific_theme`.`NAME_THEME`) = UPPER(?)))";
