<%-- 
    Document   : searchRegion
    Created on : 23-jun-2016, 16:07:27
    Author     : marce
--%>
...
<html>
    <head>
        ...
        <title>DARE-THINK: Search Region</title>
    ...
    <body>
        ...
        <div id="mainbody">
            ...
            <div class="content" style="width:70%; float:right; margin-right: 7px">
                ...
                <form id="simpleform" action="/Media_author/SearchRegion" method="post">
                    <fieldset>
